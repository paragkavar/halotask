...
-->
<div id="filterBox">
	<?php echo FORM::open(URL::base() . $controller.'/edit', array('id' => 'form_user_edit')); ?>
	...
	<table width="80%" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td>
                ...
                <div class="fLeft"><?php echo HTML::anchor('user/edit', html::image('images/save_btn_06.png', array('alt' => 'Save', 'id' => 'save_user_edit' )));?></div>
			</td>
		</tr>
	</table>
	<?php echo FORM::close(); ?>
