...
class Controller_Tasks extends Controller_Template_Default{
	...
	{		
 	...
 	public function action_edit($id=null){
		...
		if($_POST){
		    ...
		    $post_data = array_merge($_POST,array('uid_modified'=>$this->_user->id));
		    $form = $model->validate_edit($post_data);
		    $uid = $this->_user->id;
			...
			if($form->check()){
				...
				Request::instance()->redirect(URL::base() . $this->controller.'?date='.$date);
			}
			else{
	...
	*/
	...
	public function action_delete($id)
	{
		...
		Request::instance()->redirect(URL::base() . $this->controller.'?date='.$_GET['date']);	
	}
